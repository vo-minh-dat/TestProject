            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-2 px-0 position-fixed h-100 bg-white shadow-sm sidebar" id="sidebar">
                    ...
                    <div class="list-group rounded-0">
                        ...
                        <a href="/admin/borrow-request" class="active list-group-item list-group-item-action border-0 align-items-center">
                        ...
                        <table id="tbUser" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    ResultSet rs = dao.getByCondition(0);
                                    while (rs.next()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="last_row">
                                            <a href="/admin/borrow-request/accept?id=<%= rs.getInt("id")%>">
                                                <button style="margin-right: 5px;" v-if="entry.edit === false" type="button" class="btn btn-success" >
                                                    <i class="fa fa-check"></i>
                                                </button>    
                                            </a>
                                            <a onclick="return confirm('Confirm reject.')" href="/admin/borrow-request/reject?id=<%= rs.getInt("id")%>">
