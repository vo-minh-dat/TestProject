    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-2 px-0 position-fixed h-100 bg-white shadow-sm sidebar" id="sidebar">
                    ...
                    <div class="list-group rounded-0">
                        ...
                        <div class="" id="purchase-collapse" data-parent="#sidebar">
                            <div class="list-group">
                                ...
                                <a href="/admin/borrow/overdue" class="active list-group-item list-group-item-action border-0 pl-5">Overdue</a>
                        ...
                        <table id="tbUser" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="/admin/borrow/overdue" method="post">
                                            <input type="hidden" value="<%= rs.getInt("id")%>" name="id">
                                            <input type="date" name="extendDate" class="extendDate" required="required">
                                            <button style="margin-right: 5px;" v-if="entry.edit === false" type="submit" class="btn btn-primary" >
                                    ...
                                    <td>
                                        <div class="last_row">
                                            <a href="/admin/borrow/overdue/return?id=<%= rs.getInt("id")%>">
                                                <button style="margin-right: 5px;" v-if="entry.edit === false" type="button" class="btn btn-primary" >
                                                    <i class="fa fa-reply-all"></i>
                                                </button>    
                                            </a>
                                            <a href="/admin/send_message?rollnumber=<%= rs.getString("roll_number")%>">
                                                <button style="margin-right: 5px;" v-if="entry.edit === false" type="button" class="btn btn-info" >
                                                    <i class="fa fa-envelope"></i>
                                                </button>    
                                            </a>

                                            <a href="/admin/borrow/overdue/message?id=<%= rs.getInt("id")%>">
                                                <button style="margin-right: 5px;" v-if="entry.edit === false" type="button" class="btn btn-success" >
                                                    <i class="fa fa-send"></i>
                                                </button>    
                                            </a>
                                            <%= rs.getInt("condition") == 3 ? "<p>Reminded✓</p>" : ""%>
        ...
        <script>
            $(document).ready(() => {
                ...
                today = yyyy + '-' + mm + '-' + dd;
                $('.extendDate').attr('min', today);

//                $(".extendDate").setAttribute("min", today);
