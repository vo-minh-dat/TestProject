                    ...
                    <div class="list-group rounded-0">
                        ...
                        <div class="" id="purchase-collapse" data-parent="#sidebar">
                            <div class="list-group">
                                ...
                                <a href="/admin/borrow/borrowing" class="active list-group-item list-group-item-action border-0 pl-5">Borrowing</a>
                            ...
                            <tbody>
                               ...
                               %>
                                <tr>
                                    ...
                                    <td>
                                        <div class="last_row">
                                            <a href="/admin/borrow/borrowing/return?id=<%= rs.getInt("id")%>">
