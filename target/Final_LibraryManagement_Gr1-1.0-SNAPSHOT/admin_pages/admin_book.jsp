            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-10 ml-md-auto px-0">
                    ...
                    <main class="container-fluid">
                        <a href="/admin/book/insert">                        
                            <button style="margin-bottom: 20px;" type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Book</button>
                        </a>
                        <table id="tbBook" class="display" style="width:100%">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="last_row">
                                            <a href="/admin/book/update?id=<%= rs.getInt("id")%>">
                                                <button style="margin-right: 5px;" v-if="entry.edit === false" type="button" class="btn btn-warning" >
                                                    <i class="fa fa-edit"></i>
                                                </button>    
                                            </a>
                                            <a onclick="return confirm('Confirm delete.')" href="/admin/book/delete?id=<%= rs.getInt("id")%>">
