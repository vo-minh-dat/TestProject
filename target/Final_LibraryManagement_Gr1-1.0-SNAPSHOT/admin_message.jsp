...
<html>
    ...
    <body>
        ...
        <main> 
            <%                MessageDAO msDAO = new MessageDAO();
                ResultSet rs = msDAO.getAllForUser(user.getRoll_number());
                while (rs.next()) {
            %>
        </fieldset>
    </div>
    <div class="styled">
        <fieldset>
            ...
            <label for="checkbox"> <%= rs.getString("message")%></label>
        </fieldset>
        <div>
