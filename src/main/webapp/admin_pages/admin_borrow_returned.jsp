                ...
                <div class="col-md-3 col-lg-2 px-0 position-fixed h-100 bg-white shadow-sm sidebar" id="sidebar">
                    ...
                    <div class="list-group rounded-0">
                        ...
                        <div class="" id="purchase-collapse" data-parent="#sidebar">
                            <div class="list-group">
                                <a href="/admin/borrow/returned" class="active list-group-item list-group-item-action border-0 pl-5">Returned</a>
                        ...
                        <table id="tbUser" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    ResultSet rs = dao.getByCondition(2);
                                    while (rs.next()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="last_row">
                                            <a onclick="return confirm('Confirm reject.')" href="/admin/borrow/returned/delete?id=<%= rs.getInt("id")%>">
