                    ...
                    <div class="list-group rounded-0">
                        ...
                        <div class="" id="message-collapse" data-parent="#sidebar">
                            <div class="list-group">
                                <a href="/admin/all_message" class="active list-group-item list-group-item-action border-0 pl-5">User Message</a>
                        ...
                        <table id="tbUser" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= uDAO.getUserByRollnumber(rs.getString("roll_number")).getFirst_name()%> <%= uDAO.getUserByRollnumber(rs.getString("roll_number")).getLast_name()%></td>
                                    <td><%= rs.getString("subject")%></td>
                                    <td><%= rs.getString("message")%></td>

                                    <td>
                                        <div class="last_row">
                                            <a href="/admin/send_message?rollnumber=<%= rs.getString("roll_number")%>">                                                <button style="margin-right: 5px;" v-if="entry.edit === false" type="button" class="btn btn-primary" >
