...
<html>
    ...
    <body>
        <%
            ...
            User user = uDAO.getUserByRollnumber(rollnumber);
            if (user == null) {
                response.sendRedirect("/admin/user/");
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-10 ml-md-auto px-0">
                    ...
                    <main class="container-fluid">
                        <form id="validationForm" method="post" action="/admin/user/update">
                                ...
                                <div class="col-8">
                                    <div class="input-group">
                                        <input
                                            id="password"
                                            name="password"
                                            placeholder="Please enter password here if you want to change password"
                                            type="password"
                                            class="form-control"
                                            />
                                    </div>
                                ...
                                <div class="col-8">
                                    <div class="input-group">
                                        <input
                                            id="repassword"
                                            name="repassword"
                                            placeholder="Please re-enter password here if you want to change password"
                                            type="password"
                                            class="form-control"
                                            />
                                    </div>
                                ...
                                <div class="col-8">
                                    <select id="mainclass" name="mainclass" class="custom-select" required="required">
                                        ...
                                        <%
                                            ...
                                            while (rs.next()) {
                                        %>
                                        <option value="<%= rs.getString("name")%>" <%= rs.getString("name").equalsIgnoreCase(user.getMain_class()) ? "selected" : ""%>><%= rs.getString("name")%></option>
                                        <%
                                            }
                                        %>
                                    </select>
        ...
        <script>
            $(document).ready(() => {
                ...
                $("#curriculum").click(function () {
                    ...
                    if (open) {
                        window.location.href = "/admin/user/update?rollnumber=<%= rollnumber%>&major=" + $(this).val()
                    }
